  ...
  return (
    <button
      className={classNames({
        "pointer-events-none flex h-8 w-fit shrink-0 items-center justify-center truncate rounded-md px-3 py-1 text-xs font-medium transition duration-300 ease-in-out": true,
