    ...
    <button
      className={classNames({
        ...
        "bg-indigo-200 text-indigo-800 hover:bg-indigo-300 dark:bg-indigo-900 dark:text-indigo-300 dark:hover:bg-indigo-800":
          variant === "React",
        "bg-red-200 text-red-800 hover:bg-red-300 dark:bg-red-900 dark:text-red-200 dark:hover:bg-red-800": variant === "Git",
        "bg-orange-200 text-orange-800 hover:bg-orange-300 dark:bg-orange-900 dark:text-orange-300 dark:hover:bg-orange-800":
          variant === "HTML",
        "bg-blue-200 text-blue-800 hover:bg-blue-300 dark:bg-blue-900 dark:text-blue-300 dark:hover:bg-blue-800": variant === "CSS",
