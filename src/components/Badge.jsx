  ...
  return (
    <span
      className={classNames({
        ...
        "bg-heather-200 text-heather-800 dark:bg-heather-900 dark:text-heather-300":
          variant === "Internet",
        ...
        "truncate bg-cyan-200 text-cyan-800 dark:bg-cyan-900 dark:text-cyan-300":
          variant === "Package Managers",
        "truncate bg-fuchsia-200 text-fuchsia-800 dark:bg-fuchsia-900 dark:text-fuchsia-300":
          variant === "Web Design"
      })}
    >
      {children}
