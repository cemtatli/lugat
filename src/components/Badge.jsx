  ...
  return (
    <span
      className={classNames({
        "flex items-center justify-center truncate rounded-full px-2.5 py-0.5 text-xs font-medium": true,
        ...
        "bg-red-200 text-red-800 dark:bg-red-900 dark:text-red-300": variant === "Git",
        ...
        "bg-rose-200 text-rose-800 dark:bg-rose-900 dark:text-rose-300": variant === "Programming Concepts",
